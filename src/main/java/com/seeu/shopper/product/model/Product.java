...
@Table(name = "product", indexes = {
        @Index(name = "PRODUCT_INDEX1", columnList = "is_deal", unique = false),
        @Index(name = "PRODUCT_INDEX2", columnList = "status", unique = false)
})
@DynamicUpdate
public class Product {
    ...
    @Length(max = 3, message = "currency length could not larger than 3")
